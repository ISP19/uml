""" Module represents a calculation of foods in a restaurant. """
...
class Price:
    """ Class represents a price and promotion ."""
...
class Food(Price):
    """ Class represents a price and promotion of each food. """
...
class Beverage(Price):
    """ Class represents a price and promotion of each beverage. """
    def __init__(self, price: int, amount):
        juice = Price(price)
        water = Price(price)
        self.amount = amount
...
class Dessert(Price):
    """ Class represents a price and promotion of each dessert. """
    def __init__(self, price: int, amount):
        cake = Price(price)
        bread = Price(price)
        self.amount = amount
