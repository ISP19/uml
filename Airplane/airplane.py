"""Airplane class and it's relationship between Captain and Passenger class"""
class Passengers():
...
class Airplane():
    ...
    def __init__(self, name: str, model: str, capacity: int = 0, captain: Captain = ""):
        self.name = name
        self.model = model
    ...
    def add_passengers(self, passenger: Passengers):
        """Add Passengers to the Airplane"""
        self.passengers.append(passenger)

    def add_captain(self, captain: Captain):
        """Assign Captain to the Airplane"""
        self.captain = captain